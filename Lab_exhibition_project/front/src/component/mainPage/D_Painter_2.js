        ...
        return (
            <ContentStyle>
                <Grid container>
                    ...
                    <Grid item xs={4}>
                        <Card 
                            img={theme.CategoryImg["후안 그리스"]}
                            info={theme.CategoryInfo["후안 그리스"]}/>
                    </Grid>
                    <Grid item xs={4}>
                    ...
                    <Grid item xs={4}>
                        <img draggable="false" src={BTN3} alt="#" onClick={() => { this.props.setPainter("후안 그리스"); this.props.setPageNum("6") }} />
                    </Grid>
                    <Grid item xs={12}>
