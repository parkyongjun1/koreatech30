...
const CategoryInfo ={
  ...
  "후안 그리스": "출생지: 스페인 마드리드　　　　출생: 1887/03/23　　　　사망: 1927/05/11　　　　예술사조: 입체주의, 근대미술, 분석적 입체파, 종합적 입체파"
}
const PainterArts = {
  "": ["", "", ""],
  ...
  "후안 그리스": ["기타와 정물(1913)", "Germaine Raynal의 초상(1912)", "바이올린과 체커보드(1913)"],
};
...
const Masterpieces ={
  ...
  "기타와 정물(1913)":masterpiece6_1,
  "Germaine Raynal의 초상(1912)":masterpiece6_2,
  "바이올린과 체커보드(1913)":masterpiece6_3 
}
